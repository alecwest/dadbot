...
bot.addListener('message', function(from, to, message) {
    ...
    //TODO
    // xpath=/html/body/div[@id='Stage']/div[@id='Container']/div[@id='Jokes']/div[@class='JokesView']/div[@class='JokesJoke']/div[@class='wrapper']/div
    // get the 0th and 1st result for dad joke

    if (to.match(/^[#&]/)) {
        // channel message
        if (message.match(/dad\?/i)) {
            bot.say(to, 'Hi ' + from + ', I\'m dad');
        }
